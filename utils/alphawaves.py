...
class bi2013a():
    ...
    **Dataset Description**
    ...
    def __init__(self, NonAdaptive=True, Adaptive=False,
        ...
        self.online = Online
        self.subject_list = range(1, 24+1)
    ...
    def get_subject_session_data(self, subject, session):
        """return data for a single subject on a single session"""
        ...
        for file_path in file_path_list:
            ...
            if (session_name != 'session_' + str(session)):
                continue
